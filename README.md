...
```javascript
reject = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-reject@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-reject/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-reject/actions/workflows/test.yml?query=branch:v0.1.1
